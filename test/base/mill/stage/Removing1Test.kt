...
class Removing1Test {
    ...
    fun removing1() {
        assertEquals(
                ...
                Removing1.moved(
                        mill(
                                player(1, Removing1, 1, 0b000_000_000_010_100_000_010_111),
    ...
    fun keepsMoving() {
        assertEquals(
                ...
                Removing1.moved(
                        mill(
                                player(1, Removing1, 0, 0b000_000_000_010_100_000_010_111),
                                player(0, Moving, 0, 0b000_100_010_100_001_100_001_000)
                        ),
                        move(3)
                )
    ...
    fun keepsJumping() {
        assertEquals(
                ...
                Removing1.moved(
                        mill(
                                player(1, Removing1, 0, 0b000_000_000_000_000_000_000_111),
                                player(0, Moving, 0, 0b000_100_010_100_001_100_001_000)
                        ),
                        move(3)
                )
    ...
    fun moves() {
        assertEquals(
                ...
                Removing1.moves(
                        mill(
                                player(0, Removing1, 5, 0b000_110_001_000_001_000_000_000),
